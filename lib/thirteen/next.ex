defmodule Thirteen.Next do
  ...
  def throw_card_or_bet(%Game{remaining_bets: 0} = game),
    do: game |> Game.set_state(:throw_card) |> Game.change_start_hand()

  def throw_card_or_bet(game), do: game |> Game.set_state(:bet) |> Game.next_play_hand()
  ...
  def throw_or_serve_or_show_result(game), do: game |> Game.set_state(:throw_card)
